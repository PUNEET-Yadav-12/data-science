...
import joblib
import pandas as pd
from farmerdata import create_table, insert_form_data  # Importing from database.py

# Load the KMeans model, scaler, and data
kmeans = joblib.load('farmer_guider/models/kmeans_model.lb')
std = joblib.load('farmer_guider/models/standardscaler.lb')
df = pd.read_csv('farmer_guider/models/filtering_data.csv')
